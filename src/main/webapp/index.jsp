...
<body>
	...
	<div class="para1">Good, we are Here</div>

	<div class="para2">to Serve you :)</div>
	</section>
	...
	<section id="order">
		...
		<div id="sec2" class="restaurant">
			...
			<div class="rest_link">
				<a href="restraunt?name=Sajjad"><img
					src="images/slider/sajjad.jpeg" alt=""></a>
			</div>

			<div class="rest_link">
				<a href="restraunt?name=habib"><img src="images/slider/ah.png"
					alt=""></a>
			</div>

			<div class="rest_link">
				<a href="restraunt?name=Kolachi"><img
					src="images/slider/kolachi.jpg" alt=""></a>
			</div>
	...
	<section id="client">
		...
		<form id="forms" action="backend.java">
			...
			<textarea name="" id="" cols="29" rows="3"
